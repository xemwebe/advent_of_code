...
fn main() {
    ...
    if let Ok(lines) = read_lines(format!("data/input_{}.txt", riddle)) {
        let solution = match riddle.as_str() {
            ...
            _ => "Error: Solution to this riddle is not yet implemented".to_string(),
        };
...
use super::*;
    ...
    #[test]
    fn test_2015_1_1() {
        let lines = read_lines("data/input_1_1.txt").unwrap();
        assert_eq!(&riddle_1_1(lines), "232");    
    }
}