...
fn criterion_benchmark1(c: &mut Criterion) {
    c.bench_function("day 21.2", |b| b.iter(|| solve_21_2(black_box(5),black_box(6)) ));
}


fn criterion_benchmark2(c: &mut Criterion) {
    let mut cache = HashMap::new();
    c.bench_function("day 21.3", |b| b.iter(|| solve_21_3(black_box(5),black_box(6), 0, 0, &mut cache) ));
}
